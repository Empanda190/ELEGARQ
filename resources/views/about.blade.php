...
<head>
    <meta charset="utf-8">
    <title>ElegArq-Cotización</title>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Cotización</h1>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="col-lg-12">
                <div class="bg-primary py-5 px-4 px-sm-5">
                    <form class="py-5">
                        ...
                        <h1 class="mb-4">Selecciones al cliente: </h1>
                        <div class="form-group">
                        ...
                        <h1 class="mb-4">Fecha: </h1>
                        <div class="form-group">
                            <input type="date" class="form-control border-0 p-4" />
                        </div>
                        <h1 class="mb-4">Vigencia: </h1>
                        <div class="form-group">
                            <input type="date" class="form-control border-0 p-4" />
                        </div>
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control border-0 p-4" placeholder="50.23" readonly />
                        </div>
                        <div>
