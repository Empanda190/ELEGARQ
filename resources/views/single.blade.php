...
<head>
    <meta charset="utf-8">
    <title>ElegArq-Catálogo de Proveedores</title>
...
<div class="jumbotron jumbotron-fluid mb-5">
    <div class="container text-center py-5">
        <h1 class="text-white display-3">Proveedores</h1>
    </div>
</div>
<!-- Header End -->
 <!-- Blog Start -->
            ...
            <div class="row">
                <div class="col-md-13 mb-3">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="img/im4.jpg" alt="">
                    </div>
                    <div class="bg-secondary mb-3" style="padding: 30px;">
                        <div class="d-flex mb-3">
                        </div>
                        <h4 class="font-weight-bold mb-3">Cemex</h4>
                ...
                <div class="col-md-12 mb-3">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="img/im5.jpg" alt="">
                    </div>
                    <div class="bg-secondary mb-3" style="padding: 30px;">
                        <div class="d-flex mb-3">
                        </div>
                        <h4 class="font-weight-bold mb-3">Comex</h4>
                        <p>Dolor sea ipsum ipsum et. Erat duo lorem magna vero dolor dolores. Rebum eirmod no dolor diam dolor amet ipsum. Lorem lorem sea sed diam est lorem magna</p>
                        <a class="border-bottom border-primary text-uppercase text-decoration-none" href="">Mas... <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-md-12 mb-3">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="img/im6.jpg" alt="">
                    </div>
                    <div class="bg-secondary mb-3" style="padding: 30px;">
                        <div class="d-flex mb-3">
                        </div>
                        <h4 class="font-weight-bold mb-3">Truper</h4>
                        <p>Dolor sea ipsum ipsum et. Erat duo lorem magna vero dolor dolores. Rebum eirmod no dolor diam dolor amet ipsum. Lorem lorem sea sed diam est lorem magna</p>
                        <a class="border-bottom border-primary text-uppercase text-decoration-none" href="">Mas... <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
