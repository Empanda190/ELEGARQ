...
<head>
    ...
    <!-- Favicon -->
    <!-- Puedes agregar la ruta de tu favicon aquí -->
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <a href="about.php" class="nav-item nav-link">Cotización</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Cátalogos</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="blog.php" class="dropdown-item">Catálogo de Materiales</a>
                            <a href="single.php" class="dropdown-item">Catálogo de Proveedores</a>
                        </div>
                    </div>
                    <a href="service.php" class="nav-item nav-link">Registro de Pagos</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Proyectos</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="seguimiento.php" class="dropdown-item">Seguimiento de Proyectos</a>
                            <a href="registro.php" class="dropdown-item">Registro de Proyectos</a>
                        </div>
                    </div>
                </div>
            </div>
