...
/*Título: Proyecto despacho de arquitectos
    ...
    Última actualización: 29 de noviembre del 2024 - 14:00 - 14:43*/
...
Route::get('asignar_material', [elegarqcontroller::class, 'asignar_material'])->name('asignar_material');
Route::post('guardar_asignacion', [elegarqcontroller::class, 'guardar_asignacion'])->name('guardar_asignacion');
